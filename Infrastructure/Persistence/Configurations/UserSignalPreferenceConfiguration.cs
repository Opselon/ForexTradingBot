...
namespace Infrastructure.Persistence.Configurations
{
    public class UserSignalPreferenceConfiguration : IEntityTypeConfiguration<UserSignalPreference>
    {
        ...
        {
            _ = builder.ToTable("UserSignalPreferences");
            ...
            _ = builder.HasKey(usp => new { usp.UserId, usp.CategoryId });
            ...
            _ = builder.Property(usp => usp.CreatedAt).IsRequired();
            ...
            _ = builder.HasOne(usp => usp.Category)
